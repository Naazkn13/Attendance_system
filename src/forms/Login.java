...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        initComponents();
        BDUtility.setImage(this,"images/login-background.jpg",670, 508);
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(670, 508));
        setMinimumSize(new java.awt.Dimension(670, 508));
        setUndecorated(true);
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
       ...
       if ("nuzhat".equalsIgnoreCase(email)&&"nuzhat".equalsIgnoreCase(password)){
           this.dispose();
